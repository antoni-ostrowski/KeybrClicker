...
echo "  Status:   launchctl print gui/$(id -u)/com.keybrclicker"
echo "  Restart:  launchctl kickstart -k gui/$(id -u)/com.keybrclicker"
echo "  Logs:     tail -f ~/.local/state/keybrclicker/keybrclicker.log"
echo "  Stop:     launchctl bootout gui/$(id -u)/com.keybrclicker"
echo ""
echo "Uninstall:"
